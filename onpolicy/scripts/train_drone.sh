...
do
    ...
    --num_mini_batch 1 --episode_length 21 --num_env_steps 2000000000 --ppo_epoch 3 --use_ReLU --gain 0.01 \
    --lr 7e-4 --critic_lr 7e-4 --wandb_name "zero-shot-transfer" --user_name "yang-xy20" --use_macro \
    --step_difference 20 --controller_num_agents 1 --use_wandb --use_centralized_V --agg_phy_steps 4
done
