...
num_agents=50
algo="rmappo"
exp="only_ctl_normalized_50agents_64_use_normalized_delete_gt_ground_1024"
seed_max=1
...
do
    ...
    --num_landmarks ${num_landmarks} --seed ${seed} --n_training_threads 1 --n_rollout_threads 1024 \
