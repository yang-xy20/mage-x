...
do
    ...
    --num_landmarks ${num_landmarks} --seed 1 --n_training_threads 1 --n_rollout_threads 64 \
    --ctl_num_mini_batch 2 --exe_num_mini_batch 120 --episode_length 121 --num_env_steps 2000000000 \
    ...
    --use_normalized --use_exe_gnn --use_attn --hidden_size 32
done
#--layer_N 2
