...
num_agents=30
algo="rmappo"
exp="no_joint_has_entropy_macro_exe_gnn_30agents"
seed_max=1
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=5 python train/train_mpe.py --env_name ${env} --algorithm_name ${algo} \
    ...
    --step_difference 60 --controller_num_agents 1 --use_exe_gnn
done
