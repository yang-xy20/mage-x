...
do
    ...
    --num_mini_batch 60 --episode_length 60 --num_env_steps 2000000000 --ppo_epoch 3 --use_ReLU --gain 0.01 \
    --lr 7e-4 --critic_lr 7e-4 --wandb_name "mapping" --user_name "yang-xy20"
done