...
do
    ...
    --num_mini_batch 1 --episode_length 61 --num_env_steps 2000000000 --ppo_epoch 3 --use_ReLU --gain 0.01 \
    --lr 7e-4 --critic_lr 7e-4 --wandb_name "zero-shot-transfer" --user_name "yang-xy20" --use_new_loss \
    --entropy_coef 0.1 --use_macro --step_difference 60 --controller_num_agents 1 --use_gnn
done
