...
do
    ...
    --ctl_num_mini_batch 1 --exe_num_mini_batch 1 --episode_length 11 --num_env_steps 2000000000 \
    --ppo_epoch 3 --use_ReLU --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --wandb_name "mapping" \
    --user_name "yang-xy20" --use_macro --step_difference 10 --controller_num_agents 1 \
    --use_normalized --use_wandb --use_attn --use_exe_gnn --hidden_size 32
done
